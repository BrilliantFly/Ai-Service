...
public final class SfJsonUtils {
	private static final Logger logger = LoggerFactory.getLogger(SfJsonUtils.class);
	...
	public static HashMap toHashMap(Object object) {
		...
		JSONObject jsonObject = SfJsonUtils.toJSONObject(object);
	...
	public static <T, D> T toBean(String jsonString, Class<T> mainClass,
		...
		T mainEntity = SfJsonUtils.toBean(jsonObject, mainClass);
		List<D> detailList = SfJsonUtils.toList(jsonArray, detailClass);
	...
	public static <T, D1, D2> T toBean(String jsonString, Class<T> mainClass,
		...
		T mainEntity = SfJsonUtils.toBean(jsonObject, mainClass);
		List<D1> detailList1 = SfJsonUtils.toList(jsonArray1, detailClass1);
		List<D2> detailList2 = SfJsonUtils.toList(jsonArray2, detailClass2);
	...
	public static <T, D1, D2, D3> T toBean(String jsonString,
		...
		List<D1> detailList1 = SfJsonUtils.toList(jsonArray1, detailClass1);
		List<D2> detailList2 = SfJsonUtils.toList(jsonArray2, detailClass2);
		List<D3> detailList3 = SfJsonUtils.toList(jsonArray3, detailClass3);
