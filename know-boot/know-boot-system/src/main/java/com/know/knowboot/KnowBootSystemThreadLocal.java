...
import com.know.knowboot.util.ListUtils;
 ...
 * 本地线程
 */
public class KnowBootSystemThreadLocal {

    /**
     * 构造方法
     */
    public KnowBootSystemThreadLocal() {}
    ...
    public static Integer getAdminId() {
        String adminId = KnowBootSystemThreadLocal.get("adminId").toString();
        if (adminId.equals("")) {
            return 0;
        }
    ...
    public static List<Integer> getRoleIds() {
        String roleIds = KnowBootSystemThreadLocal.get("roleIds").toString();
