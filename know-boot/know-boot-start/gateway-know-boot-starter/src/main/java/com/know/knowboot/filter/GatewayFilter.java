...
import com.know.knowboot.utils.AddressUtils;
...
public class GatewayFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        log.info("当前请求---------------- ip ---> {}", remoteAddress.getHostName());
        log.info("当前请求---------------- ip ---> {}", AddressUtils.getRealAddressByIP(remoteAddress.getHostName()));
