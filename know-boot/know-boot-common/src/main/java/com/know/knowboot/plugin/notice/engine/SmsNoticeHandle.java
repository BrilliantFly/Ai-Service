package com.know.knowboot.plugin.notice.engine;


import com.know.knowboot.entity.notice.NoticeRecord;
...
import com.know.knowboot.mapper.notice.NoticeRecordMapper;
...
import com.know.knowboot.plugin.sms.SmsDriver;
import com.know.knowboot.util.ConfigUtils;
import com.know.knowboot.util.StringUtils;

import java.util.*;

import static com.know.knowboot.common.SpringUtils.*;
...
public class SmsNoticeHandle {
    ...
    public void send(NoticeSmsVo noticeSmsVo, SmsTemplate smsTemplate) {
        ...
        // 消息记录
        NoticeRecordMapper noticeRecordMapper = getBean(NoticeRecordMapper.class);
        ...
        //记录到sms log
        SmsLogMapper smsLogMapper = getBean(SmsLogMapper.class);
