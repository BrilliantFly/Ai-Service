...
// * 字符串实用类，进行字符串的相关操作。
// */
//public final class StringExtendUtils {
//
...
//     * @return
//     */
//    public static String trun(String value, int length) {
//        if (isEmpty(value))
//            return "";
...
//
//    /**
//     * 根据指定的字符把数组连接起来，并返回连接成的新字符串。如果数组为NULL，则返回NULL。
//     * <p>
//     * Examples:
//     * <p>
//     * <pre>
...
//
//    /**
//     * 根据指定的字符把数组的某一部分连接起来，并返回连接成的新字符串。 如果数组为NULL，则返回NULL；如果endIndex <=
//     * startIndex，则返回空字符串。
//     * <p>
//     *
//     * @param array      对象数组
...
//     * @return
//     */
//    public static String trimQuan(String s) {
//        int len = s.length();
//        int start = 0;
...
//     *          中国电信拥有号码段：133、153、189（3G）、180（3G）;4个号码段移动:
//     *          2G号段(GSM网络)有139,138,137,136,135,134(0-8),159,158,152,151,150
//     *          3G号段(TD-SCDMA网络)有157,188,187 147是移动TD上网卡专用号段.
//     *          联通:2G号段(GSM网络)有130,131,132,155,156 3G号段(WCDMA网络)有186,185 电信:
...
//        Pattern p = Pattern.compile("^((13[0-9])|(15[0-9])|(16[0-9])|(17[0-9])|(14[0-9])|(18[0-9])|(19[0-9]))\\d{8}$");
...
//        Pattern p = Pattern.compile("^[1-9]\\d{5}[1-9]\\d{3}((0[1-9])|(1[0-2]))([0][1-9]|([1|2]\\d)|3[0-1])\\d{3}([0-9]|x|X)$");
//        Matcher m = p.matcher(idcard);
//        return m.matches();
//    }
//
//    public static boolean isVehicleClass(String idcard) {
//        Pattern p = Pattern.compile("A[1-3]|B[1-2]|C[1-5]|D|E|F|M|N|P");
//        Matcher m = p.matcher(idcard);
//        return m.matches();
//    }
//
...
//     * @return
//     */
//    public static String invertedOrder(String string){
//
//        String[] arr = string.split(" ");//按空格分割
//        int length = arr.length;//计算数组长度
//        StringBuilder sb = new StringBuilder(string.length());//新建一个StringBuilder对象
...
//     * @return
//     */
//    public static String invertedOrderString(String string){
//
//        String resultString = "";
...
//     * @return
//     */
//    public static String getSubString(String string, String param){
//        return string.substring(0, string.indexOf(param));
//    }
//
//
//    /**
